...
export default tseslint.config(
    ...
    settings: {
      'import/resolver': {
        typescript: {
          project: [
            './tsconfig.json',
            './template/sparkling-app-template/tsconfig.json',
          ],
        },
      },
  ...
  // Relax rules for the app template (frontend TSX files)
  {
    files: ['template/sparkling-app-template/src/**/*.{ts,tsx}'],
    rules: {
      // App template files are user-land and don't require repo-wide license headers
      'headers/header-format': 'off',
      // Avoid false positives in TS import paths
      'n/file-extension-in-import': 'off',
    },
    settings: {
      'import/resolver': {
        typescript: {
          project: './template/sparkling-app-template/tsconfig.json',
        },
      },
    },
  },
